...
INSERT INTO user (username, email, password, status, onwikiname, checkuser) VALUES ('Admin',
'admin@localhost', ':2:x:$2y$10$FMnMGBrMxq0t8cZyt1W19uWtvgz/RhE97P2S6GJQqL3FCXuQR6g62', 'Admin', 'Admin', '1');
INSERT INTO user (username, email, password, status, onwikiname, checkuser) VALUES ('AdminNoCU',
'adminnocu@localhost', ':2:x:$2y$10$xakiGCcCO650y6Ol5WRly.h37YapozGFjf8yLtTs62UBJ7l0D39zG', 'Admin', 'AdminNoCU', '0');
INSERT INTO user (username, email, password, status, onwikiname, checkuser) VALUES ('CheckUser',
'checkuser@localhost', ':2:x:$2y$10$tbsxnW6BihFA08detKhTDe4BCf5g81uIlmSxxT7Scl3uRLjB/EO3G', 'User', 'CheckUser', '1');
INSERT INTO user (username, email, password, status, onwikiname, checkuser) VALUES ('User',
'user@localhost', ':2:x:$2y$10$yPcHbYPigFRWjruyvWX3n.xGv7HRSaO1bNlfBivGCNvVCE0qy4QfO', 'User', 'User', '0');
INSERT INTO user (username, email, password, status, onwikiname, checkuser) VALUES ('New',
